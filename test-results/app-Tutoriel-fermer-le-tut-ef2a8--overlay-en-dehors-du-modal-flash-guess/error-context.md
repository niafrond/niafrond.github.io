...
- Name: flash-guess/tests/e2e/app.spec.js >> Tutoriel >> fermer le tutoriel en cliquant sur l'overlay en dehors du modal
- Location: flash-guess/tests/e2e/app.spec.js:447:3
