...
- Name: flash-guess/tests/e2e/app.spec.js >> Quitter une partie en cours >> le bouton Quitter est présent pendant le gameplay
- Location: flash-guess/tests/e2e/app.spec.js:330:3
