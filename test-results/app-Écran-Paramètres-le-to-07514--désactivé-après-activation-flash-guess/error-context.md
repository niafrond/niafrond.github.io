...
- Name: flash-guess/tests/e2e/app.spec.js >> Écran Paramètres >> le toggle Mode Enfant peut être désactivé après activation
- Location: flash-guess/tests/e2e/app.spec.js:383:3
