...
- Name: flash-guess/tests/e2e/app.spec.js >> Démarrage d'une partie >> le bouton Commencer la manche est présent
- Location: flash-guess/tests/e2e/app.spec.js:281:3
