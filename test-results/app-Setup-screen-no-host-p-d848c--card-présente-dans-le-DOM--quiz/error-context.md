...
- Name: quiz/tests/e2e/app.spec.js >> Setup screen (no ?host param) >> le classement local peut être affiché (card présente dans le DOM)
- Location: quiz/tests/e2e/app.spec.js:26:3
