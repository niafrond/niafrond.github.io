...
- Name: flash-guess/tests/e2e/app.spec.js >> Écran des catégories >> Tout désélectionner désactive le bouton Confirmer
- Location: flash-guess/tests/e2e/app.spec.js:194:3
