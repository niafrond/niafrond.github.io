 ...
 * MediaBrowserServiceCompat + MediaSessionCompat. Les commandes (lecture,
 * pause, suivant, seek, lecture depuis la file) sont relayées vers le code
 * web (player.js / main.js) par MediaSessionPlugin.
 */
public class MediaPlaybackService extends MediaBrowserServiceCompat {
    ...
    /** Construit un MediaItem jouable à partir des données poussées par main.js. */
    public static MediaBrowserCompat.MediaItem buildMediaItem(String id, String title, String artist, String artworkUrl) {
    ...
    public void updateQueue(List<MediaBrowserCompat.MediaItem> items) {
        queueItems.clear();
    ...
    public void updateMetadata(MediaMetadataCompat metadata, String artworkUrl) {
    ...
    /**
     * Relaie une commande vers le code web. Si l'application n'est pas (encore)
     * démarrée — par ex. connexion à froid depuis Android Auto — on lance
     * MainActivity, qui transmettra la commande à main.js dès que la WebView
     * sera prête (voir MediaSessionPlugin.getPendingCommand).
     */
